...
const useWriteHooks = ()=>{
    ...
    return [ title, setTitle, content, setContent, path, setPath, selector, setSelector, imgUrl, setImgUrl, page, setPage, onChange, onClick, onImageChange ]
}

export default useWriteHooks;